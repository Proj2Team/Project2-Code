...
<form action='editStudent.php' method='post' class="center-form form-clean space-children-input text-center-input">
...
' required><p>
  ...
  *Select Major(s):<br>
  <select name='majors[]' multiple='multiple' class='medium-select'>
  ...
  <input type='submit' value='Apply Changes' name='studentButton' class='button'> <p>
